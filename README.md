...
| 插件 | 适合的工作方式 | 当前发布版本 |
| --- | --- | --- |
| [AI SOW Lite](plugins/ai-sow-lite/README.md) | 从 PRD、HLD 和往期 SOW 生成首稿，查看 Excel 后通过 `clarify` 讨论并应用局部修改。 | [0.1.0-alpha.1](https://github.com/InspireChina/ai-plugin-marketplace/releases/tag/ai-sow-lite-v0.1.0-alpha.1) |
...
两个版本均于 2026-09-11 公开预发布，仍需用户核对结果。各插件独立安装、独立维护项目数据，无需同时安装。能力和限制见各插件 README，版本变化见 [CHANGELOG](CHANGELOG.md)。

...
**Spec:** [D00](../../design/detailed/D00-technology-stack.md)、[D02](../../design/detailed/D02-shared-data-and-evidence.md)、[D06](../../design/detailed/D06-excel-projection-and-delivery.md)、[D07](../../design/detailed/D07-tools-storage-and-recovery.md)、[D08](../../design/detailed/D08-telemetry-and-performance.md)、[P00](P00-contracts-and-fixtures.md)。
...
**Files:** 新建 tests/support/smoke_plugin.py、docs/archive/validation/I1-delivery.md；更新 references/tools.md、CHANGELOG.md 与 D09 证据状态。
...
当前反馈实施边界见 [D06](../../design/detailed/D06-excel-projection-and-delivery.md) 与 [AD33](../../design/13-self-review-and-decisions.md#ad33--四表原列与验收成果)。新旧模板兼容需用旧模板测试夹具核对，仅内存复制新版校验列 prototype/A2，原项目模板字节和 hash 不变，prepared/projection 仍绑定实际项目 hash；不修改上面历史勾选及实测值。

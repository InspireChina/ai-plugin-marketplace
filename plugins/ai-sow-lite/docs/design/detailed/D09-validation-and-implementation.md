...
I2.1—I2.2 已完成；真实 Skill、历史变体、有限问答和文件续接已经演练，回归及最终独立复审通过，见 [I2 验证](../../validation/I2-generate.md)。原始语义失败、安装反例与局部复验分别保留。下列整体条件仍包含 I2.3 的宿主调用、输入出口补充验证及计量集成，不提前关闭这些范围。

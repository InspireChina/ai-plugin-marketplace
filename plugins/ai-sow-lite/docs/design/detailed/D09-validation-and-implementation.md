...
当前实施：I1.1 已完成；I1.2 已实现真实文本/分析登记、有限读取与本地存储/恢复接缝，实际测试、审阅状态和限制见 [I1 验证](../../validation/I1-reliable-delivery.md)。下列整体验收及 I1—I4 复选框仍按增量关闭，不能把候选检查或受控存储包当作完整 I1。I1.3 已接入真实 Excel 投影/核验与公共 Generate apply，回归和原生检查通过，独立审阅及定点复核已通过；I1.4 观测和 I1.5 完整副本验收仍待完成。
...
| 有限探针 | EX06 初始检查及 I1.1 两轮真实探针确认了当前版本的 usage 载体、response/turn 算术和限制 | 已接通采集器、完整记录请求或精确归到每个活动 |

...
- [x] 执行 `uv run --project plugins/ai-sow-lite --locked pytest plugins/ai-sow-lite/tests/test_skill_contracts.py plugins/ai-sow-lite/tests/test_contracts.py -q`，然后把真实演练证据写入 docs/validation/I2-generate.md。专业判断不按固定 Story/Task 数判通过。

...
- `GREENFIELD`、`BROWNFIELD`、`IN_SCOPE`、`FULLY_COVERED`、`INTERNAL`、`EXTERNAL`、`REUSE`、`RENDER_ONLY`、`FULL_COMPILE`、`DELTA_COMPILE`、`MODEL_ACTION_GROUP`、`REQUEST_INPUT`、`REQUEST_APPROVAL`、`FRESH_NO_HISTORY`、`PUBLISHED`、`REUSED` 等 machine token；
...
最终 Excel 遵循展示层规则：业务 Sheet 不显示稳定 ID，使用 reviewed SOW Model 中唯一、非空的名称进行

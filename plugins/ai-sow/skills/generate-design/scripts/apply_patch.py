...
WORK_ROOT = ".ai-sow/work/generate-design"
    ...
    commands = (
        ...
        (
            ...
            [
                ...
                "review",
                "--candidate",
                f"{WORK_ROOT}/design.candidate.json",
                "--requirements-candidate",
                f"{WORK_ROOT}/requirements.candidate.json",
                "--review-path",
...
if __name__ == "__main__":
    raise SystemExit(
        run_patch_cli(
            OWNER,
            f"{WORK_ROOT}/design.candidate.json",
            additional_candidates=(f"{WORK_ROOT}/requirements.candidate.json",),
